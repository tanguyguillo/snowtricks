 ...
 */
final class Version20221117111026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_9474526CB46B9EE8 ON comment');
        $this->addSql('DROP INDEX IDX_9474526C9D86650F ON comment');
        $this->addSql('ALTER TABLE comment CHANGE trick_id_id trick_id INT NOT NULL, CHANGE user_id_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE trick_id trick_id_id INT NOT NULL, CHANGE user_id user_id_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9474526CB46B9EE8 ON comment (trick_id_id)');
